    ...
    <ul className="cards">
      ...
      <li className="card card_theme_grey">
        ...
        <p className="card__text card_theme_grey">
          Фирма образована в 1999 году в составе немецкого холдинга SP AG. По
          2011 год обслуживала один из крупнейших проектов Санкт-Петербурга в
          области коммерческой недвижимости – строительство Торгового центра
          STOCKMANN на Невском пр. 114.
        </p>
      ...
      <li className="card card_theme_grey">
        ...
        <p className="card__text card_theme_grey">
          ...
          <br />
          <br />
          Сопровождение девелоперского greenfield проекта в Промышленном парке
          "Софийский".
          <br />
          <br />
